...
Last updated: 18/09/2015 5:27PM 5th commit
...
atl_EmPbnds[1] = atl_EmPbnds[0] + atl_EmPbnds[1]
atl_EmPbnds[0] = pl.float64('nan')
...
q1 = ax1.bar(ind,atl_EmPbnds,width,color='k')
...
w1 = ax2.bar(ind,pac_EmPbnds,width,color='k')
...
s1 = ax3.bar(ind,ind_EmPbnds,width,color='k')
...
ax3.legend((s1[0],s2[0],s3[0]),('$E-P$','$E$','$P$'),loc=2)
