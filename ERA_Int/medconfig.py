...
Mediterranean & Black Seas configuration, medcconfig.py. To be read by click2.py.
...
bounds = pl.array([[47.5,28.0,40.5],[29.5,13.0,22.0]])

m = Basemap(llcrnrlon=-15.,llcrnrlat=25.,urcrnrlon=50.,urcrnrlat=50.,
