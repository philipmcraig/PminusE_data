...
Atlantic Ocean configuration, atlanticconfig.py. To be read by click2.py.
...
bounds = pl.array([[60.0,-65.0,7.0],[-35.0,-59.0,20.0]])

m = Basemap(llcrnrlon=-105.,llcrnrlat=-40.,urcrnrlon=45.,urcrnrlat=65.,
